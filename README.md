...
```yaml
env:
  DISCOURSE_HOSTNAME: forums.kicksecure.com
  DISCOURSE_BACKUP_HOSTNAME: forums.w5j6stm77zs6652pgsij4awcjeel3eco7kvipheu6mtr623eyyehj4yd.onion
...
hooks:
  after_code:
    - exec:
        cd: $home/plugins
        cmd:
          - git clone https://github.com/org-ai-assisted/discourse-kicksecure-onion-host-support.git
```
...
CLEAR=forums.kicksecure.com
ONION=forums.w5j6stm77zs6652pgsij4awcjeel3eco7kvipheu6mtr623eyyehj4yd.onion
...
`org-ai-assisted/discourse-whonix-onion-host-support` for the
Whonix forums.
